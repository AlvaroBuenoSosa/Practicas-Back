...
public class PdfGenerator {
    ...
    public void generateClientePdf(ClienteReportDto dto, String filePath) throws IOException, DocumentException {
        ...
        try {
            ...
            // Accounts
            for (ClienteReportDto.CuentaDto cuenta : dto.getCuentas()) {
                ...
                // Movements
                for (ClienteReportDto.MovimientoDto movimiento : cuenta.getMovimientos()) {
